...
const CareerGuideHero = ({
  ...
  >
    {/* --- FIX: Overlay darkened for better text readability --- */}
  ...
  return (
    <div className="bg-main min-h-screen font-sans flex flex-col">
      ...
      <div className="flex-grow pt-16">
        <div
          className={`sticky z-40 bg-subtle/95 backdrop-blur-sm border-b border-border transition-all duration-300 ${
                ...
                {mainNav.map((tab) => (
                  <div key={tab.id} className="relative">
                    <button
                      ...
                      className={`flex items-center text-sm font-semibold px-4 py-5 transition-colors duration-200 ${
                        activeTab === tab.id
                          ? "text-violet-600"
