...
import { EmployerProfile as EmployerProfileType, CategorizedSkills, Skill } from "@/types/employer";
...
const AnandResumeTemplate = React.forwardRef<HTMLDivElement, { profile: EmployerProfileType }>(({ profile }, ref) => {
    return (
        <div ref={ref} id="resume-to-download" className="bg-white font-sans" style={{ width: '210mm', minHeight: '297mm' }}>
                            ...
                            <div className="mt-6 space-y-3">
                                ...
                                {profile.documents && profile.documents.length > 0 && (
                                    profile.documents.map((doc) => (
                                        <div key={doc.public_id} className="flex items-center gap-3">
