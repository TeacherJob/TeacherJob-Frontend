...
const PostJob = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Fixed Banner Section with Gradient Overlay */}
      <section className="relative py-20 sm:py-24 lg:py-32 bg-slate-50 overflow-hidden">
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-orange-100 via-white to-blue-100 opacity-90" />
